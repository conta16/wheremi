...
function copyVideoFields() {
	var title=$("#title").val();
	$("#video-title")[0].innerHTML=title;
	var description=$("#description").val();
	$("#video-description")[0].innerHTML=description;
}
		...
		<div class="filesloader-wrap">
				<div class="fileupload-buttonbar">
					  <span class="btn btn-white fileinput-button">
						...
						<span type="button" class="btn btn-primary" data-toggle="modal" data-target="#clipModal" onclick="copyVideoFields()">
							Create clip
						</span>
				</div>
		</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="clipModalLabel">Crea una clip</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        </button>
      </div>
      <div class="modal-body">

			<div class="w-100" id="video-div">
